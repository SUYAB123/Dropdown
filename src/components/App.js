    ...
    <div id="main">
      ...
      <div id="city-name">
        <select id="city" onChange={changeCity}>
          {states[stateindex].city.map((item, i) => (
      ...
      <div id="landmark-name">
        <select id="landmark" onChange={changelandmark}>
          {states[stateindex].city[cityindex].landmarks.map((item, i) => (
            <option value={i}>{item.name}</option>
          ))}
        </select>
      </div>
      ...
      <div id="landmark-description">
        {
          states[stateindex].city[cityindex].landmarks[landmarkindex]
            .description
        }
      </div>
    </div>
